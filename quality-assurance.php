...
<section class="banner-commun banner_jobs">
  <div class="banner-commun_text">
    <h1 class="title-primary text-center color-white" data-aos="fade-up">Quality Assurance - QA</h1>
  </div>
</section>
  ...
  <div class="container">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item color-white" aria-current="page">Quality Assurance - QA</li>
      </ol>
    </nav>
